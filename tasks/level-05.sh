...
{
# requires manual SGR start and end sequence to not break the info color:
info "The file '$(sgr bold)"$file"$(spread sgr not,dim)' contains a list of pizzas together with their ingredients.
"
